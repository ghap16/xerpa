...
class AnimalTestCase(TestCase):
    def setUp(self):
        self.valid_image = 'https://media.wired.com/photos/Uber_Logobit_Digital_black.jpg'
        self.invalid_image = 'https://media.wired.com/photos/Uber_Logobit_Digital_black.html'
